...
namespace ECommBackend.Repositories.RepoInterfaces
{
    public interface IImageRepo
    {
        ...
        public Task<IQueryable<ImageModel>?> GetAllImages(CancellationToken ctx);
        public Task<Guid> UploadImage(ImageModel _imageModel,Guid _variantId ,CancellationToken ctx);
